...
const (
	TaskService_ScheduleTask_FullMethodName  = "/task.TaskService/ScheduleTask"
...
func (c *taskServiceClient) ScheduleTask(ctx context.Context, in *TaskRequest, opts ...grpc.CallOption) (*TaskResponse, error) {
...
func (UnimplementedTaskServiceServer) ScheduleTask(context.Context, *TaskRequest) (*TaskResponse, error) {
...
func _TaskService_ScheduleTask_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TaskServiceServer).ScheduleTask(ctx, req.(*TaskRequest))
	}
